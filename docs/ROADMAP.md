...
attribute-key admission, permanent pre-sink rejection, and dedicated limit
observability are implemented. Full per-series cardinality, temporality, and
downstream Amber semantics remain.
